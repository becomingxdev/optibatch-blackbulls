...
const AboutUs = () => {
  return (
    <section className="min-h-screen w-full flex flex-col items-center justify-center py-24 px-6 relative z-10">
      ...
      {/* Deep Space Background gradient purely for this section to transition from the dashboard */}
      ...
      <div className="max-w-5xl w-full mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Pioneering the next generation of intelligent industrial optimization. We blend bleeding-edge Artificial Intelligence with high-performance telemetry infrastructure.
          </p>
        </div>
